  ...
  nodes: {
    ...
    scene2: {
      ...
      choices: [
        ...
        { id: "s2_b", label: "Trả lời bình thường", next: "scene3", effect: { stats: { T: 5 } } },
        {
          id: "s2_c",
          label: "Giữ riêng tư",
          next: "scene3",
    ...
    scene3: {
      ...
      choices: [
        ...
        { id: "s3_c", label: "Hỏi “có chuyện gì không?”", next: "scene3a", effect: { stats: { A: 5 } } },
      ],
    },
